    ...
    nextToPhase2.addEventListener('click', () => {
        ...
        const ageClean = age.value.trim();
        const dobClean = dateOfBirth.value.trim();
        ...
        if (fNameClean === "" || lNameClean === "" || ageClean === "" || dobClean === "" || genderClean === "") {
            ...
            validationAlert.classList.remove('d-none');
            validationAlert.textContent = "Validation Failure: Age must be below 80!";
            return;
        }
        else if (ageClean <= 18) {
            validationAlert.classList.remove('d-none');
            validationAlert.textContent = "Validation Failure: Age must be over 18!";
            return;
        }
    ...
    nextToPhase3.addEventListener('click', () => {
        ...
        const formattedDob = dob.value.trim().toUpperCase();
        ...
        previewAge.textContent = `${formattedAge}, ${formattedDob} `;
        previewGender.textContent = `${formattedGender}`;
    ...
    restartBtn.addEventListener('click', () => {
        ...
        currentAddress.value = ""; permanentAddress.value = ""; age.value = ""; dob.value = ""; gender.value = "";
